    ...
    public class ChatModule : AbpModule
{
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<ChatModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<ChatModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<ChatModule>(/* validate: true */);
        });
    }
    ...
    {
        context.Services.AddDataProtection().SetApplicationName("Chat");
    }
